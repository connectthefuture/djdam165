...
urlpatterns = patterns('searcher.views',
                      ...
                      (r'^yesterday-looklet-selects/$', 'yesterday_looklet_selects'),
                      ...
                      (r'^weeks-looklet-selects/$', 'weeks_looklet_selects'),
                      ...
                      (r'^lastweeks-looklet-selects/$', 'lastweeks_looklet_selects'),
                      (r'^lastmonths-looklet-selects/$', 'lastmonths_looklet_selects'),
                      (r'^today-all-selects/$', 'today_all_selects'),
