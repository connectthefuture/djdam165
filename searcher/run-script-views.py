...
def script_runner_home_page(request):
    ...
    if script_selected and styles:
        ...
        return render_to_response('listing/script_output_page.html', {'styles': styles, 'script': script_selected, 'results': res.items()}, context_instance=RequestContext(request))
