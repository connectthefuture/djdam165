...
class ProductSnapshotLiveAutoCompleteWidget(forms.widgets.TextInput):
...
class ProductSnapshotLiveAutoCompleteField(forms.fields.CharField):
    """
    ...
    def __init__(self, model,  lookup_url, *args, **kwargs):
        ...
        super(ProductSnapshotLiveAutoCompleteField, self).__init__(
            widget = ProductSnapshotLiveAutoCompleteWidget(lookup_url=self.url),
            max_length=255,
            *args, **kwargs)
