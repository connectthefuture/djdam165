...
urlpatterns = patterns('base.views',
                       ...
                       url(r'^mongodisplay/?.*?$', 'mongodisplay', name='mongodisplay'),
                       url(r'^mongo_imagesobj/?(?P<objectid>\s*?)?', 'unwind_metadata_array_duplicate', name='unwind_metadata_array_duplicate'),
                       url(r'^mongo_imagesdata/?(?P<data_src>\s*?)?', 'unwind_metadata_array_duplicate', name='unwind_metadata_array_duplicate2'),
