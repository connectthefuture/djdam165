...
urlpatterns = patterns('base.views',
                       ...
                       url(r'/mongo_imagesobj/(?P<objectid>)', 'unwind_metadata_array_duplicate', name='unwind_metadata_array_duplicate'),
                       url(r'/mongo_imagesdata/(?P<data_src>)', 'unwind_metadata_array_duplicate', name='unwind_metadata_array_duplicate'),
